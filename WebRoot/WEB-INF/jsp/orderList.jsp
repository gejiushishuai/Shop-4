			...
			<table>
				<tbody>
					<s:iterator var="order" value="pageBean.list">
						...
						<tr>
							<td colspan="5" height="20" bgcolor="#86969F" ></td>
						</tr>
					</s:iterator>
					<tr>
						<td colspan="5">
							<div class="pagination">
								...
								<s:iterator begin="1" end="pageBean.totalPage" var="i">
									...
									<s:else>
										<a
											href="${pageContext.request.contextPath}/order_findOrdersByUid.action?page=<s:property value="#i"/>"><s:property
												value="#i" /></a>
									</s:else>
								</s:iterator>
								<s:if test="pageBean.page!=pageBean.totalPage">
									<a class="nextPage"
										href="${pageContext.request.contextPath}/order_findOrdersByUid.action?page=<s:property value="pageBean.page+1"/>">&nbsp;</a>
									<a class="lastPage"
										href="${pageContext.request.contextPath}/order_findOrdersByUid.action?page=<s:property value="pageBean.totalPage"/>">&nbsp;</a>
								</s:if>
							</div>
						</td>
					</tr>
