...
<script>
	...
	function change() {
		...
		captchaImage.src = "${pageContext.request.contextPath}/checkImg.action?"
				+ new Date().getTime();
	}
</script>
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="password" id="password" name="password"
										class="text" maxlength="20" autocomplete="off" /> <span><s:fielderror
												fieldName="password"></s:fielderror></span></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" id="email" name="email"
										class="text" maxlength="200"> <span><s:fielderror
												fieldName="email"></s:fielderror></span></td>
								</tr>
								<tr>
									<th>姓名:</th>
									<td><input type="text" name="name" class="text"
										maxlength="200"> <span><s:fielderror
												fieldName="name"></s:fielderror></span></td>
								</tr>
								<tr>
									<th>电话:</th>
								...
								<tr>
									...
									<td><input type="text" name="addr" class="text"
										maxlength="200"> <span><s:fielderror
												fieldName="addr"></s:fielderror></span></td>
								</tr>
								<tr>
